...
alDataset = '<activity_log_dataset_here>'
alDatasetKey = '<key_here>'
pagesize = 100
page = 1
...
datasetsToExclude = ['<dataset_name>']
...
query = '{"$and": [ { "_timestamp": {"$gte": 10} }, { "$or" : [{"@type": "al:Update" }, {"@type": "al:Create" }] } ]}'
...
numResults = responseObject['documentCount']
resultsPage = responseObject['page']
resultsPageSize = responseObject['pagesize']
